...
**Legacy:** `config/crops.json`, env `CROPS_CONFIG_PATH`  
...
## Старое имя документа

Ранее файл назывался [rag-crops_config.md](./rag-crops_config.md) (термин `crop_id`). Содержание актуализировано под `domain_id`.
